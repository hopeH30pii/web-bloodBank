...
if (isset($_POST['submit-img'])) {
    ...
    $dst_fname =  getcwd() . '/blood cells/' . time() . uniqid(rand()) . '.' . $extension;
...
<body>
    ...
    <section class="book" id="book">
        ...
        <h1 class="heading"> <span>Pneumonia</span> Detection <span>Using BLOOD CELLS</span> </h1>
        ...
        <table class="content-table">
            ...
            <tr>
                ...
                <td><?php echo $result['prob_NEUTROPHIL'] ?></td>
            </tr>
            <tr>
                <th>Probability of Pneumonia</th>
                <td><?php echo $result['prob_BASOPHIL'] ?></td>
            </tr>
        </table>
        <p>
